 ...
 * Use the [MovieNowPlayingFragment.newInstance] factory method to
...
class MovieNowPlayingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_movienowplaying, container, false)
    }
